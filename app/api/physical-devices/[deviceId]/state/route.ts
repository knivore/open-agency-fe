...
import type { PhysicalDeviceState } from '@/lib/api/backend/physicalDevices';
import {
...
export async function GET(
  ...
  try {
    ...
    const payload = await agencyApiClient.get<PhysicalDeviceState>(
      backendRoutes.physicalDevices.state(deviceId),
      {
