...
export default function WorkflowListWorkspace() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3 border-b border-primary-100 pb-5">
        <div>
          <h1 className="agency-gradient-text text-2xl font-semibold tracking-tight">Workflows</h1>
          <p className="text-sm text-neutral-500">
            Canonical workflow definitions from `/workflows`. This is the backend-first workspace
            index.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button asChild size="sm" variant="outline">
                    <Link href={`/workflows/${workflow.id}/view`}>Builder</Link>
                  </Button>
