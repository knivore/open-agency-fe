...
import type { WorkflowMonitoringEventsResponse, WorkflowMonitoringProposalEvent } from '@/types/workflows';
...
function pendingApproval(proposal: WorkflowMonitoringProposalEvent) {
  return (proposal.approval_requests ?? []).find((approval) => approval.status === 'pending') ?? null;
}
