  ...
  const content = editable ? (
    ...
    <div className="grid gap-3 text-sm sm:grid-cols-2 xl:grid-cols-4">
      <div className="rounded-md border border-neutral-200 bg-neutral-50/70 px-3 py-2">
        <dt className="text-xs font-medium uppercase text-neutral-500">Runtime adapter</dt>
        <dd className="mt-1 font-medium text-neutral-900">
          {selectedAdapterId || preferredAdapterId || 'Not set'}
        </dd>
      </div>
      <div className="rounded-md border border-neutral-200 bg-neutral-50/70 px-3 py-2">
        <dt className="text-xs font-medium uppercase text-neutral-500">Execution host</dt>
        <dd className="mt-1 font-medium text-neutral-900">{host}</dd>
      </div>
      <div className="rounded-md border border-neutral-200 bg-neutral-50/70 px-3 py-2">
        <dt className="text-xs font-medium uppercase text-neutral-500">Preferred adapter</dt>
        <dd className="mt-1 font-medium text-neutral-900">{preferredAdapterId || 'Not set'}</dd>
      </div>
      <div className="rounded-md border border-neutral-200 bg-neutral-50/70 px-3 py-2">
        <dt className="text-xs font-medium uppercase text-neutral-500">Available adapters</dt>
        <dd className="mt-1 font-medium text-neutral-900">{adapterCount}</dd>
      </div>
    </div>
  );
