// Taken from: https://github.com/sersavan/shadcn-multi-select-component
...
import { Popover, PopoverContent, PopoverTrigger } from '../library/shadcn/popover';
import {
  Command,
  CommandEmpty,
  CommandGroup,
    ...
    React.useEffect(() => {
      setSelectedValues((current) => {
        const hasSameValues =
          ...
          current.every((value, index) => value === defaultValue[index]);

        return hasSameValues ? current : defaultValue;
      });
    }, [defaultValue]);
